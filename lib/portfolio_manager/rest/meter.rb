...
module PortfolioManager
  module REST
    ...
    module Meter
      ...
      # pagination template:
      # "/customer/#{customerId}/meter/whatChanged?nextPageKey=#{next_page_key}&date=#{since_date}"
      ...
      # pagination template:
      # "/customer/#{customerId}/meter/consumptionData/whatChanged?nextPageKey=#{next_page_key}&date=#{since_date}"
